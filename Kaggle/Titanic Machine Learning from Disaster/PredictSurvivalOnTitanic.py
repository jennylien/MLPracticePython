...
#read in the submition file
final=pd.read_csv("final_submission.csv", index_col=0)
final.insert(loc=0, column = "Survived", value=prediction)

print(final)
final.to_csv("Titanic_final_submission.csv")